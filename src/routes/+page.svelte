...
<script lang="ts">
  import TopContainer from './components/Home/TopContainer.svelte'
  import MainContainer from './components/Home/MainContainer.svelte'
...
<svelte:head>
  ...
  <title>Mohamed Aymen Daassi</title>
